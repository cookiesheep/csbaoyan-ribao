...
$env:PYTHONPATH = "D:\code\csbaoyan\src;D:\code\csbaoyan\.venv\Lib\site-packages"
...
if ($UseExistingDatabase) {
    ...
    Ensure-QqRunning
    Logm "step1 decrypt"
    $decryptOutput = & C:\Users\wqf18\miniconda3\python.exe D:\code\qq_dump_db\dump_qq_key_auto.py --qq 2272735608 2>&1 | Out-String
...
$ingestOutput = & C:\Users\wqf18\miniconda3\python.exe -m csbaoyan_daily.cli ingest --date $Date 2>&1 | Out-String
